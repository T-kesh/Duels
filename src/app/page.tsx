  ...
  return (
    <main className="min-h-screen bg-duel-bg flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      <div className="z-10 text-center w-full max-w-sm">
        {/* Logo/Icon — drops in first */}
        <div className="relative inline-block mb-6 animate-hero-drop">
        ...
        {/* Title */}
        <h1 className="text-6xl font-bold text-duel-gold tracking-[0.15em] mb-2 drop-shadow-[0_0_30px_rgba(252,196,25,0.3)] uppercase animate-rise-in [animation-delay:150ms]">
          Duel
        </h1>
        <p className="text-[10px] text-muted-foreground tracking-[0.5em] uppercase mb-10 animate-rise-in [animation-delay:250ms]">
        ...
        {/* How to Play Card */}
        <div className="glass border-white/5 p-6 mb-10 text-left relative overflow-hidden animate-rise-in [animation-delay:350ms]">
          ...
          <ul className="space-y-3">
            {[
              ...
              <li
                key={i}
                className="flex gap-4 items-start animate-rise-in"
        ...
        {wrongNetwork && (
          <div className="glass border-destructive/30 px-4 py-3 rounded-xl mb-6 text-center space-y-2 animate-rise-in">
        ...
        {/* Actions */}
        <div className="flex flex-col gap-4 items-center w-full animate-rise-in [animation-delay:700ms]">
          {isConnected ? (
            <>
              <GlowButton
        ...
        {/* Footer info */}
        <footer className="mt-16 animate-rise-in [animation-delay:900ms]">
